...
| Layer | Technologies |
|---|---|
| **Data Engineering** | PySpark **3.5.1**<br>Pandas **2.1.4**<br>PyArrow **14.0.2** |
| **NLP** | rank-bm25 **0.2.2**<br>TextBlob **0.17.1**<br>NLTK **3.8.1**<br>Scikit-learn **1.4.2** |
| **Visualization** | Plotly **5.20.0**<br>WordCloud **1.9.3** |
| **Backend** | FastAPI **0.111.0**<br>Uvicorn **0.29.0**<br>Pydantic **2.7.1** |
| **Frontend** | Streamlit **1.35.0** |
| **AI** | Groq **0.9.0** *(llama-3.1-8b-instant)* |
| **Collection** | feedparser **6.0.11**<br>BeautifulSoup4 **4.12.3**<br>PRAW **7.7.1** |
| **Runtime** | Python **3.10+**<br>Java **11+** *(Spark dependency)* |
